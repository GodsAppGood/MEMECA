  ...
  public: {
    Tables: {
      ...
      WidgetAnalytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "WidgetAnalytics_meme_id_fkey"
            columns: ["meme_id"]
            isOneToOne: false
            referencedRelation: "Memes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "WidgetAnalytics_slot_id_fkey"
            columns: ["slot_id"]
            isOneToOne: false
            referencedRelation: "WidgetSlots"
            referencedColumns: ["id"]
          },
        ]
      }
      WidgetSlots: {
        ...
        Relationships: [
          {
            foreignKeyName: "WidgetSlots_meme_id_fkey"
            columns: ["meme_id"]
            isOneToOne: false
            referencedRelation: "Memes"
            referencedColumns: ["id"]
