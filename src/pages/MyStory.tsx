    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 md:py-16">
        <section className="mb-12 md:mb-20">
          <h1 className="text-3xl md:text-4xl font-bold font-serif mb-8 md:mb-12 text-center">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            <div className="w-full lg:w-1/2">
              <img
                ...
                className="w-full max-w-[500px] h-auto mx-auto rounded-lg shadow-lg"
              />
            </div>
            <div className="w-full lg:w-1/2 prose prose-sm md:prose-lg max-w-none">
              ...
              <h2 className="text-xl md:text-2xl font-bold mt-6 md:mt-8 mb-4">What makes MemeCatLandar special?</h2>
              ...
              <p className="mt-6 md:mt-8">With love,<br />Ann Ostrovsky</p>
            </div>
          </div>
        </section>

        <section className="mb-12 md:mb-20">
          <h2 className="text-2xl md:text-3xl font-bold font-serif mb-8 md:mb-12 text-center">About Project</h2>
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            <div className="w-full lg:w-1/2">
              <img
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-start">
            <div className="w-full lg:w-1/2">
              <img
                ...
                alt="Tuzemoon Mascot"
                className="w-full max-w-[500px] h-auto mx-auto rounded-lg shadow-lg animate-float"
              />
            </div>
            <div className="w-full lg:w-1/2 prose prose-sm md:prose-lg max-w-none">
              <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6 md:mb-8">Tuzemoon RoadMap</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">1. Listing on Dexscreener</h3>
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">2. Regular Platform Updates</h3>
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">3. Integration of an AI Assistant</h3>
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">4. Fully Automated Platform</h3>
