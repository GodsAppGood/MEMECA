        ...
        <section className="mb-20">
          <div className="w-full max-w-4xl mx-auto relative">
            <Button
              ...
              className="absolute top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-[#FFB74D] hover:bg-[#FFB74D]/90 text-black animate-pulse-border px-8 rounded-full"
            >
